...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
						...
						<!-- <li><a class="nav-link" href="#footer">Login</a></li> -->
    ...
    <!-- The data display from the database -->
<div>
<?php
include "connection.php";
...
<!-- The end of the data display -->
<!-- The map of the coolected data  -->
          ...
          <div class="row">
            ...
            <div class="form-box">
                ...
                <table class="table table-responsive d-table">
                  <tr>
                    <td><input type="text" class="form-control pl-0" placeholder="NAME" name="Name" /></td>
                  ...
                  <tr>
                    <td colspan="2"><input type="text" class="form-control pl-0" placeholder="ADDRESS" name="address"  /></td>
                  </tr>
                  <tr>
                    <td colspan="2"></td>
                  </tr>
                  ...
                  <tr>
                    <!-- <td colspan="2" class="text-center pl-0"><input type="submit" name="submit" value="Submit" ></td> -->
